...
import (
	...
	"github.com/irdkwmnsb/webrtc-grabber/pkg/config"
	"github.com/irdkwmnsb/webrtc-grabber/pkg/sfu"
	"github.com/irdkwmnsb/webrtc-grabber/internal/sockets"
	"github.com/irdkwmnsb/webrtc-grabber/internal/utils"
)
...
//
// Parameters:
//   - config: Server configuration loaded from configs/signalling.json
